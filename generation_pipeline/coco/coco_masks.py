...
def get_instance_masks(coco_annotation_file, class_name, output_size=(512, 512), T=1e4):
...
def get_instance_img(coco_annotation_file, class_name, output_size=(512, 512), T=1e4):
    # Load the COCO annotation file
    coco = COCO(coco_annotation_file)
