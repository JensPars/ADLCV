...
wandb.init(project = "copy-paste-project", name=f"mask-rcnn-{'copy-paste' if args.copy_paste else 'plain'}-{str(args.data_fraction)}-data")
...
for epoch in range(num_epochs):
    ...
    if val_loss < best_val_loss:
        ...
        model_path = f'/work3/s194633/{"copy_paste" if args.copy_paste else "plain"}_best_maskrcnn_car_boat_bus_train_{str(args.data_fraction)}_data.pth'
